...
Rem: KEYSTRAT 1.7 - Layout1.bas (Qwerty)
Rem: ***********************************
Option Explicit
Rem: Declare Variables
Dim layout1_lockon As Boolean
Dim layout1_shifton As Boolean
Rem: Setup Layout According to Lock and Shift Status
Public Sub Layout1_Setup()
    If (Main.Shift_Light.BackColor = &HFF00&) Then 'Shift Light On
        Layout1_Shift_On
        layout1_shifton = True
    Else 'Shift Light Off
        Layout1_Shift_Off
        layout1_shifton = False
    End If
    ...
    Else 'Lock Light Off
        Layout1_Lock_Off
        layout1_lockon = False
    End If
    Layout1_Static_Keys
End Sub
Rem: Toggle Lock Status
Public Sub Layout1_Toggle_Lock()
    If layout1_lockon Then
        Layout1_Lock_Off
        layout1_lockon = False
    Else
        Layout1_Lock_On
...
Public Sub Layout1_Toggle_Shift()
    If layout1_shifton Then
        Layout1_Shift_Off
        layout1_shifton = False
    Else
        Layout1_Shift_On
...
End Sub
Rem: Static Keys
Private Sub Layout1_Static_Keys()
    ...
    Main.Keyboard_Array(55).Caption = "stop"  ' Label key with stop
End Sub
Rem: Lock On
Private Sub Layout1_Lock_On()
    Main.Keyboard_Array(15).Caption = "Q"     ' Relabel key
    Main.Keyboard_Array(16).Caption = "W"     ' Relabel key
    Main.Keyboard_Array(17).Caption = "E"     ' Relabel key
    Main.Keyboard_Array(18).Caption = "R"     ' Relabel key
    Main.Keyboard_Array(19).Caption = "T"     ' Relabel key
    Main.Keyboard_Array(20).Caption = "Y"     ' Relabel key
    Main.Keyboard_Array(21).Caption = "U"     ' Relabel key
    Main.Keyboard_Array(22).Caption = "I"     ' Relabel key
    Main.Keyboard_Array(23).Caption = "O"     ' Relabel key
    Main.Keyboard_Array(24).Caption = "P"     ' Relabel key
    Main.Keyboard_Array(29).Caption = "A"     ' Relabel key
    Main.Keyboard_Array(30).Caption = "S"     ' Relabel key
    Main.Keyboard_Array(31).Caption = "D"     ' Relabel key
    Main.Keyboard_Array(32).Caption = "F"     ' Relabel key
    Main.Keyboard_Array(33).Caption = "G"     ' Relabel key
    Main.Keyboard_Array(34).Caption = "H"     ' Relabel key
    Main.Keyboard_Array(35).Caption = "J"     ' Relabel key
    Main.Keyboard_Array(36).Caption = "K"     ' Relabel key
    Main.Keyboard_Array(37).Caption = "L"     ' Relabel key
    Main.Keyboard_Array(43).Caption = "Z"     ' Relabel key
    Main.Keyboard_Array(44).Caption = "X"     ' Relabel key
    Main.Keyboard_Array(45).Caption = "C"     ' Relabel key
    Main.Keyboard_Array(46).Caption = "V"     ' Relabel key
    Main.Keyboard_Array(47).Caption = "B"     ' Relabel key
    Main.Keyboard_Array(48).Caption = "N"     ' Relabel key
    Main.Keyboard_Array(49).Caption = "M"     ' Relabel key
End Sub
Rem: Lock Off
Private Sub Layout1_Lock_Off()
    Main.Keyboard_Array(15).Caption = "q"     ' Relabel key
    Main.Keyboard_Array(16).Caption = "w"     ' Relabel key
    Main.Keyboard_Array(17).Caption = "e"     ' Relabel key
    Main.Keyboard_Array(18).Caption = "r"     ' Relabel key
